...
"server1": {
        ...
        "api_key": "ptla_x8EiVvWg0w8UnfNc6qCmvL5tuPP3KaH6fmHFVvDB7to,",
        "client_api_key": "ptlc_BtXLfSc4kQlUYSRXOY942JOB53VtZc4D4xegIq5lnRh"
    }
...
def create_server(panel_id, user_id, name, egg_id, node_id, cpu, ram, disk):
    try:
        ...
        egg_configs = {
            ...
            15: {  # NodeJS
                "docker_image": "ghcr.io/kochengku/nodejs_20_kocheng:latest",
    ...
    "description": "Kocheng's |> Sahabat Ai Nusantara"
}
