...
print(f"[SCHEDULER] Job: {job} | Waktu: {now}")

# =========================
# ✅ ROUTING + FILTER WAKTU AMAN
# =========================

# ✅ 1 MINGGU 1X → MINGGU JAM 03:00
...
# ✅ 24 JAM 1X → JAM 02:00
    ...
    if now.hour == 2:
        ...
        print("⏭️ Skip shutdown_inactive (belum jam 2 pagi)")
