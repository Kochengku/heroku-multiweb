...
import os
from config_web3 import admin_mail

# Header API
PANELS = {
    "server1": {
        "url": "https://console.skyforgia.web.id",
        "api_key": "ptla_6CQ8Rfx3r34t2KOMedBjfreQ1sqJrBOu62knYPqfFCq",
        "client_api_key": "ptlc_TB1pjR7lhEXrXgz0bAcyd8Yf28DNpWLDz3hnv2DGFm5"
    }
